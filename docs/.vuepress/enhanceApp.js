...
function integrateGitment(router) {
    ...
    function renderGitment(parentEl, path) {
        ...
        const gitment = new Gitment({
            id: path,
            owner: "PeterChen1997", // 必须是你自己的github账号
            repo: "Frontend-Repo",
            link: location.origin + path,
            oauth: {
                client_id: "c16d424e292195ea5d29", // 第一步注册 OAuth application 后获取到的 Client ID
                client_secret: "e37a52f52ed6ae94a03c98b3f5fb040691a8926e", // 第一步注册 OAuth application 后获取到的 Clien Secret
            },
        });
